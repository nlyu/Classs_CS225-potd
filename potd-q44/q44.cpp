...
int check(int *arr, int SIZE){
    ...
    for(int i = 0; i<(SIZE*SIZE); i++){
        if(arr[i] == 1 || arr[i] == 2){
            ...
            if((i/SIZE+2)<SIZE && (i%SIZE+2) <=(SIZE-1)){
                if((arr[i] == 1 && arr[i+SIZE*1+1] == 1 && arr [i+SIZE*2+2] == 1)) 
                    return 1;
                else if((arr[i] == 2 && arr[i+SIZE*1+1] == 2 && arr [i+SIZE*2+2] == 2))
                    return 2; 
            }
            ...
            if((i/SIZE +2)<SIZE){
                if((arr[i] == 1 && arr[i+SIZE*1] == 1 && arr [i+SIZE*2] == 1)) 
                    return 1;
                else if((arr[i] == 2 && arr[i+SIZE*1] == 2 && arr [i+SIZE*2] == 2))
                    return 2; 
            }
